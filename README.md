...
Performance:
On held-out test data, the trained model achieves R² values of 0.83, 0.76, and 0.69 across the three output dimensions, with mean absolute errors of 0.20, 0.20, and 0.19 (in normalized space). The final ELBO of $\approx$ -3.05 million indicates successful convergence for this dataset size.
